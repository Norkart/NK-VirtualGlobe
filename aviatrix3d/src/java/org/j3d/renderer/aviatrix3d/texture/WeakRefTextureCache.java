...
*/
    ...
    public boolean checkTexture(String filename)
    {
        ...
        WeakReference ref = (WeakReference)textureMap.get(filename);
        if(ref != null)
        {
    ...
    {
        boolean ret_val = false;
        WeakReference ref = (WeakReference)componentMap.get( filename );
        if(ref != null)
        {
            TextureComponent tex = (TextureComponent)ref.get();
            if(tex != null)
                ret_val = true;
            else
                componentMap.remove(filename);
...
*/
    ...
    private TextureComponent getTextureComponent(String name)
    {
        ...
        TextureComponent ret_val = (TextureComponent)ref.get();
        if(ret_val == null)
