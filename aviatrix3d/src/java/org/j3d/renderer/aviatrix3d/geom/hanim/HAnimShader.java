    ...
    implements Comparable
{
    ...
    static
    {
        ...
        InputStream[] is = (InputStream[])AccessController.doPrivileged(
            new PrivilegedAction()
            {
                public Object run()
                {
                    InputStream[] ret_val =
                    {
                        ClassLoader.getSystemResourceAsStream(CORE_SHADER_FILE),
                        ClassLoader.getSystemResourceAsStream(LIGHTING_SHADER_FILE),
                        ClassLoader.getSystemResourceAsStream(FOG_COORD_SHADER_FILE),
                    };
        ...
        if(is[0] == null)
        {
            ...
            is[0] = (InputStream)cldr.getResourceAsStream(CORE_SHADER_FILE);
            is[1] = (InputStream)cldr.getResourceAsStream(LIGHTING_SHADER_FILE);
            is[2] = (InputStream)cldr.getResourceAsStream(FOG_COORD_SHADER_FILE);
//            is[3] = (InputStream)cldr.getResourceAsStream(TEXTURE_SHADER_FILE);
//            is[4] = (InputStream)cldr.getResourceAsStream(FOG_SHADER_FILE);
        }
