    ...
    implements ShaderSourceRenderable
{
    ...
    /** Flag indicating that a compilation has been requested */
    ...
    protected void setUpdateHandler(NodeUpdateHandler handler)
    {
        ...
        if(compileRequested && (updateHandler != null))
    ...
    {
        if((compiled && !compileRequested) || sourceStrings == null)
            return;
    ...
    {
        return compiled && !compileRequested;
    }
