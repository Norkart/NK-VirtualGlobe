...
public class ByteBufferTextureComponent2D extends TextureComponent2D
{
	...
	{
		this(0, 0, 0, ByteBuffer.allocate( 0 ));
	}
		...
		ByteBuffer src )
	{
		...
		data[0] = ( src == null ) ? ByteBuffer.allocate( 0 ) : src;
	}
		...
		ByteBuffer[] src )
	{
		...
		{
			data[i] = ( src[i] == null ) ? ByteBuffer.allocate( 0 ) : src[i];
		}
	}
	...
	{
		System.out.println( "convertImage " + level );
		return( data[level] );
	}
}
