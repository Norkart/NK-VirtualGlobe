...
public class SpotLight extends Light
{
    ...
    private static final String ANGLE_RANGE_MSG =
        "The angle provided is outside the allowed range of 0 to 90 degrees";

    /** Message when the spot exponent is negative */
    private static final String NEG_EXP_MSG =
        "The exponent value provided is negative. Must be >= 0";
