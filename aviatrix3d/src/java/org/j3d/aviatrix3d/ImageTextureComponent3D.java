...
{
    private static final String MATCH_FORMAT_MSG =
...
System.out.println("ImageTextureComponent3D Short gray Image conversion not implemented yet");
            ...
            default:
                System.out.println("ImageTextureComponent3D Unsupported image type " +
                                   img_0.getType());
        }

        ret_val = ByteBuffer.allocate(width * height * depth * num_comp);
...
System.out.println("ImageTextureComponent3D Short gray Image conversion not implemented yet");
            ...
            default:
                System.out.println("ImageTextureComponent3D Unsupported image type " + img.getType());
        }
