    ...
    implements RenderingProcessor
{
    ...
    /** alphaTest value for the parts of transparent objects that should be handled as opaque */
    protected float alphaCut;
     ...
     */
    protected BaseRenderingProcessor(GLContext context)
    {
        glContext = context;
