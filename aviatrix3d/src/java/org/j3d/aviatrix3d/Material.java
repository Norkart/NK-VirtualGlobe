    ...
    implements ObjectRenderable
{
    ...
    private static final String COLOR_MATERIAL_TARGET_ERR =
        "The value provided for the color material target is invalid. It " +
        "must be one of the *_TARGET values defined by this class.";
    /**
     * Error message when the user attempts to set a value for a backface
     * property when it is not currently enabled.
     */
    private static final String NO_BACKFACE_WRITE_MSG =
        "The separate back-face material setting is not currently enabled. " +
        "You are not permitted to write to this value.";

    /**
     * Error message when the user attempts to read a value for a backface
     * property when it is not currently enabled.
     */
    private static final String NO_BACKFACE_READ_MSG =
        "The separate back-face material setting is not currently enabled. " +
        "You are not permitted to read this value.";
