    ...
    implements ObjectRenderable
{
    ...
    private static final String NO_POINT_SPRITE_MSG =
        "Video card incapable of supporting point sprites.";

    /**
     * Message for an invalid index being provided to the setCombineSource
     * method.
     */
    private static final String INVALID_OP_IDX_MSG =
        "The operation index provided is invalid. Must be 0, 1 or 2 only";
        ...
        throws InvalidWriteTimingException
    {
        ...
        if(alpha)
        {
            ...
            switch(opIdx)
            {
                ...
                default:
                    throw new IllegalArgumentException(INVALID_OP_IDX_MSG);
            }
        }
        else
        {
