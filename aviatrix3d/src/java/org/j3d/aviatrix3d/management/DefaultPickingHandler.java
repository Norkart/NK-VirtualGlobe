    ...
    implements PickingManager
{
    ...
    private static final String NO_PICK_TYPE_MSG =
        "AV3D: No or unknown picking type has been specified in the PickRequest";

    /** Message when the PickRequest doesn't have one of the required types */
    private static final String NO_SORT_TYPE_MSG =
        "AV3D: No or unknown sorting type has been specified in the PickRequest";

    /** Message when the proxy geometry is not a known picking type */
    private static final String UNKNOWN_PROXY_TYPE_MSG =
        "AV3D Proxy geometry contains an unknown picking type so we can't " +
        "evaluate it. Defaulting back to the normal geometry.";
        ...
        throws NotPickableException
    {
        ...
        switch(req.pickGeometryType)
        {
            ...
            default:
                errorReporter.warningReport(NO_PICK_TYPE_MSG, null);
        }
    ...
    private void pickPoint(PickTarget root, PickRequest req)
    {
        switch(req.pickSortType)
        {
            ...
            default:
                errorReporter.warningReport(NO_SORT_TYPE_MSG, null);
        }
    }
                                ...
                                boolean needTransform)
    {
        ...
        if(bounds instanceof BoundingGeometry)
        {
            ...
            {
                return pickAllCylinder((CustomPickTarget)target_node,
                                       req,
                                       center,
                                       axis,
                                       radius,
                                ...
                                boolean needTransform)
    {
        ...
        switch(child.getPickTargetType())
        {
            ...
            case PickTarget.CUSTOM_PICK_TYPE:
                found = pickAllCylinder((CustomPickTarget)child,
                                        req,
                                        center,
                                        axis,
                                        radius,
                                   ...
                                   boolean needTransform)
    {
        ...
        if(bounds instanceof BoundingGeometry)
        {
            ...
            {
                return pickSingleCone((CustomPickTarget)target_node,
                                      req,
                                      vertex,
                                      axis,
                                      angle,
                                   ...
                                   boolean needTransform)
    {
		...
		break;
            ...
            case PickTarget.CUSTOM_PICK_TYPE:
                found = pickSingleCone((CustomPickTarget)child,
                                       req,
                                       vertex,
                                       axis,
                                       angle,
                                  ...
                                  boolean needTransform)
    {
        ...
        if(bounds instanceof BoundingGeometry)
        {
            ...
            {
                return pickSingleBox((CustomPickTarget)target_node,
                                     req,
                                     min,
                                     max,
                                     path,
