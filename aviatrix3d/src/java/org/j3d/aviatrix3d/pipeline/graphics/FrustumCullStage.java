...
public class FrustumCullStage extends BaseCullStage
{
                                  ...
                                  int layerIndex)
    {
		...
		// TODO: how to add global lights in multi pass mode ?
    }
                                     ...
                                     GraphicsEnvironmentData envData)
    {
        ...
        if (view.getProjectionType() == ViewEnvironmentCullable.PERSPECTIVE_PROJECTION) 
            ...
            angularResolution = (float)Math.toDegrees(Math.atan2(frustum[1], frustum[5]) - Math.atan2(frustum[0], frustum[5]));
        }
    ...
    private void updateFrustum(GraphicsEnvironmentData envData)
    {
        ...
        if (envData.viewProjectionType == ViewEnvironmentCullable.PERSPECTIVE_PROJECTION) {
