...
public class StateAndTransparencyDepthSortStage extends BaseStateSortStage
{
                            ...
                            int instrCount)
    {
        ...
        for(int i = 0; i < trans && !terminate; i++)
        {
            ...
            if (!(unsortedTransparentList[i].renderable instanceof Node))
                continue;
            Node node = (Node)unsortedTransparentList[i].renderable;
        ...
        try {
            ...
            System.out.println("depthValue: " + depthList2[jidx]);
            System.out.println("depth range: " + depth_range + " quanta: " + quanta + " accuracy: " + depthAccuracy + " min_depth: " + min_depth);
        }
