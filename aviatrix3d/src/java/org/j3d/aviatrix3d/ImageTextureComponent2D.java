    ...
    private ByteBuffer convertImage(BufferedImage img)
    {
        ...
        switch(img.getType())
        {
            ...
            case BufferedImage.TYPE_USHORT_565_RGB:
                ...
                ret_val = ByteBuffer.allocate(width * height * 3);
            ...
            case BufferedImage.TYPE_INT_ARGB:
                ...
                ret_val = ByteBuffer.allocate(width * height * 4);
                ret_val.order(ByteOrder.nativeOrder());
            ...
            case BufferedImage.TYPE_BYTE_BINARY:
                ...
                switch(num_comp)
                {
                    case 1:
                        ...
                        // alpha or gray maps
                        ret_val = ByteBuffer.allocate(width * height);
                        ret_val.order(ByteOrder.nativeOrder());
                    ...
                    case 2:
                        ...
                        ret_val = ByteBuffer.allocate(width * height * 2);
                        ret_val.order(ByteOrder.nativeOrder());
...
//System.out.println("Binary Grayscale Image conversion not implemented yet");
//                break;
...
System.out.println("ImageTextureComponent2D ARGB-premult Image conversion not implemented yet");
             ...
             default:
                System.out.println("ImageTextureComponent2D Unsupported image type " + img.getType());
        }
