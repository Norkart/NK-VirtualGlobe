...
/** Test case for Bug #53b from bugzilla.xj3d.org.
  * Testing whether a PROTO with an eventIn and eventOut IS'd
  * gets the whole event circuit.
  *
  * Modification of main test case, modified to use a PROTO with
  * an EXPOSEDFIELD to generate duplicate events.
  */

public class Bug53b implements vrml.eai.event.VrmlEventListener,
    BrowserListener {
...
public static void main(String[] args) {
    new Bug53b(TestFactory.getBrowser()).run();
}
...
public void run() {
    String s="PROTO dup [exposedField MFNode children [] ] { Group { children IS children} } dup {}\n";
