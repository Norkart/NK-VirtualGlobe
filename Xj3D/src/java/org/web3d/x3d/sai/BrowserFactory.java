 ...
 * <UL>
 * <LI><CODE>x3d.sai.factory.class</CODE>
 * </UL>
...
public class BrowserFactory {
    ...
    static {
        ...
        String factory_class_name = (String)AccessController.doPrivileged(
    ...
    public static X3DComponent createX3DComponent(Map params)
        ...
        X3DComponent comp = factory.createComponent(params);
     ...
     * the embbed X3D browser starting from the top of the page. If there are
