...
/**
 * Java3D implementation of a GeoLocation node
 * <p>
 *
 * @author Justin Couch
 * @version $Revision: 1.2 $
 */
public class J3DGeoLocation extends BaseGeoLocation
    ...
    /** Mapping of the VRMLNodeType to the J3D Group instance */
     ...
     */
    public J3DGeoLocation(VRMLNodeType node) {
        super(node);
    }
...
//            if((isDEF || shareCount > 1) && !hasBindables)
        ...
        // finally update the transform based on the converted transformation
        // that was completed in the base class setupFinished();
        locationMatrix.m03 = (float)localCoords[0];
        locationMatrix.m13 = (float)localCoords[1];
        locationMatrix.m23 = (float)localCoords[2];

        transform.set(locationMatrix);
    ...
    //----------------------------------------------------------
    // Methods defined by BaseGeoLocation
    //----------------------------------------------------------
