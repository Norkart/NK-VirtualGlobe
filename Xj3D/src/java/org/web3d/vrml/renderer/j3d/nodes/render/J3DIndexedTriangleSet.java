...
/**
 * Java3D implementation of an IndexedTriangleSet.
 * <p>
 *
 * @author Alan Hudson
 * @version $Revision: 1.5 $
 */
public class J3DIndexedTriangleSet extends BaseIndexedTriangleSet
     ...
     */
    public J3DIndexedTriangleSet(VRMLNodeType node) {
        super(node);
    ...
    protected void buildImpl() {
        ...
        if (vfNormal != null) {
            ...
            if (!indexed || implGeom == null) {
                ...
                implGeom = new IndexedTriangleArray(vfCoord.getNumPoints() / 3,
                ...
                ((IndexedTriangleArray)implGeom).setCoordinateIndices(0, vfIndex);
                ((IndexedTriangleArray)implGeom).setValidIndexCount(numIndex);
