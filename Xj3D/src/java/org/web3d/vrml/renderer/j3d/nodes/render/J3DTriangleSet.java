 ...
 */
public class J3DTriangleSet extends BaseTriangleSet
     ...
     */
    public J3DTriangleSet(VRMLNodeType node) {
        super(node);
    ...
    protected void buildImpl() {
        ...
        if (vfNormal != null) {
            ...
            if (implGeom == null) {
                ...
                implGeom = new TriangleArray(vfCoord.getNumPoints() / 3,
                                                    getFormat(),
                                                    num_tex_sets,
                                                    tex_maps);
