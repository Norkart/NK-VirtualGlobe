...
/**
 * Java3D implementation of an GeoViewpoint
 * <p>
 *
 * @author Justin Couch
 * @version $Revision: 1.2 $
 */
public class J3DGeoViewpoint extends BaseGeoViewpoint
     ...
     */
    public J3DGeoViewpoint(VRMLNodeType node) {
        super(node);
    }

    //-------------------------------------------------------------
    // Methods defined by J3DViewpointNodeType
    //-------------------------------------------------------------
    ...
    //----------------------------------------------------------
    // Methods internal to J3DGeoViewpoint
    //----------------------------------------------------------
