...
/**
 * Java3D renderer implementation of a ExplosionEmitter node.
 * <p>
 *
 * The current implementation does not handle changing any of the
 * parameters currently.
 *
 * @author Justin Couch
 * @version $Revision: 1.2 $
 */
public class J3DExplosionEmitter extends BaseExplosionEmitter
    implements J3DVRMLNode {

    /**
     * Construct a new time sensor object
     */
    public J3DExplosionEmitter() {
    }
     ...
     */
    public J3DExplosionEmitter(VRMLNodeType node) {
        super(node);
    }
