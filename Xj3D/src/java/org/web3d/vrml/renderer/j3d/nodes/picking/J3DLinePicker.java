...
/**
 * Java3D renderer implementation of a LinePicker node.
 * <p>
 *
 * @author Justin Couch
 * @version $Revision: 1.5 $
 */
public class J3DLinePicker extends BaseLinePicker
     ...
     */
    public J3DLinePicker(VRMLNodeType node) {
        super(node);
        targetSet = new HashMap();
        allParentPaths = new ObjectArray();
    }
        ...
        for(int i = 0; i < numValid; i++) {
            if (targets[i] instanceof VRMLProtoInstance) {
                ...
                if (node instanceof VRMLProtoInstance) {
                    System.out.println("PROTO walk not implemented in J3DLinePicker");
                }
