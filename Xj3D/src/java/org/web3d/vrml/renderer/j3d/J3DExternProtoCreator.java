 ...
 */
class J3DExternProtoCreator extends CRExternProtoCreator {

    /** The proto instance we're building up */
    private J3DProtoInstance protoInstance;
     ...
     */
    public J3DExternProtoCreator(String worldURL) {
     ...
     */
    J3DProtoInstance createInstance(ExternalPrototypeDecl proto) {
        ...
        J3DProtoInstance protoInstance =
            new J3DProtoInstance(proto.getVRMLNodeName(),
                                 isVRML97,
                                 field_decls,
                                 0);
