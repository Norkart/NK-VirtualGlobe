...
/**
 * Java3D-renderer implementation of NurbsCurve.
 *
 * @author Justin Couch
 * @version $Revision: 1.4 $
 */
public class J3DNurbsCurve extends BaseNurbsCurve
     ...
     */
    public J3DNurbsCurve(VRMLNodeType node) {
        super(node);
    ...
    public void allEventsComplete() {
        ...
        if(!regenerateCurve()) {
            System.err.println("Bad curve data. Curve removed");
