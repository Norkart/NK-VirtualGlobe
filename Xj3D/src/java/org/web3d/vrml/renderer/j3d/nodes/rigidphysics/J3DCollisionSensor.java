...
/**
 * Java3D Implementation of a CollisionSensor node.
 * <p>
 *
 *
 * @author Justin Couch
 ...
 */
public class J3DCollisionSensor extends BaseCollisionSensor
     ...
     */
    public J3DCollisionSensor(VRMLNodeType node) {
        super(node);
    }
    ...
    protected BaseContact generateNewContact() {
        J3DContact contact = new J3DContact();
