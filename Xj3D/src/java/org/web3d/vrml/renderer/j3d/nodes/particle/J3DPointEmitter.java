...
/**
 * Java3D renderer implementation of a PointEmitter node.
 * <p>
 *
 ...
 */
public class J3DPointEmitter extends BasePointEmitter
    implements J3DVRMLNode {

    /**
     * Construct a new time sensor object
     */
    public J3DPointEmitter() {
    }
     ...
     */
    public J3DPointEmitter(VRMLNodeType node) {
        super(node);
    }
