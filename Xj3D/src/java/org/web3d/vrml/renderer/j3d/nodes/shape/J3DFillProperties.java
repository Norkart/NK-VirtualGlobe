...
/**
 * Java3D renderer implementation of an FillProperties node.
 * <p>
 *
 * @author Justin Couch
 * @version $Revision: 1.1 $
 */
public class J3DFillProperties extends BaseFillProperties
    implements J3DVRMLNode {

    /** Java3D line attribute handling */
    private PolygonAttributes j3dAttribs;

    /**
     * Empty constructor
     */
    public J3DFillProperties() {
    }
     ...
     */
    public J3DFillProperties(VRMLNodeType node) {
        super(node);
    }
