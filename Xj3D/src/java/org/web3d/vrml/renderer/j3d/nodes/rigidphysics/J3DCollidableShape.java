...
/**
 * Java3D Implementation of a CollidableShape node.
 * <p>
 *
 *
 * @author Justin Couch
 ...
 */
public class J3DCollidableShape extends BaseCollidableShape
     ...
     */
    public J3DCollidableShape(VRMLNodeType node) {
        super(node);
        init();
    }
    ...
    public void setupFinished() {
        ...
        if(vfShape != null) {
            SceneGraphObject sgo = ((J3DVRMLNode)vfShape).getSceneGraphObject();
            if(sgo != null) {
