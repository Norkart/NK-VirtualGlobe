 ...
 */
public class J3DExternPrototypeDecl extends CRExternPrototypeDecl {
     ...
     */
    public J3DExternPrototypeDecl(String name,
                                  VRMLNodeFactory fac,
                                  int majorVersion,
                                  int minorVersion,
    ...
    public void setContent(String mimetype, Object content)
        ...
        J3DProtoCreator creator =
            new J3DProtoCreator(nodeFactory,
                                worldURL,
                                isVrml97 ? 2 : 3,
                                0);
