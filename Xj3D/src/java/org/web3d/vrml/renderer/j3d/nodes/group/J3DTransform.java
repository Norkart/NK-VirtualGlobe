...
/**
 * Java3D implementation of a transform node.
 * <p>
 *
...
public class J3DTransform extends J3DGroupingNode {
    ...
    private static final int FIELD_ROTATION = LAST_GROUP_INDEX + 2;
    private static final int FIELD_SCALE = LAST_GROUP_INDEX + 3;
    private static final int FIELD_SCALE_ORIENTATION = LAST_GROUP_INDEX + 4;
    private static final int FIELD_TRANSLATION = LAST_GROUP_INDEX + 5;

    /** The last field index used by this class */
    private static final int LAST_TRANSFORM_INDEX = FIELD_TRANSLATION;
     ...
     *    fields
     * @throws InvalidFieldValueException The string does not contain an
    ...
    /**
     * Check to make sure vfScale is valid
     *
     * Valid value are: vfScale > 0.0
     * If not, throw a InvalidFieldValueException
     *
     * @param newScale The proposed scale value
     * @throws InvalidFieldValueException Invalid scale value
     */
    private void checkScale(float[] newScale)
        throws InvalidFieldValueException {

        if((vrmlMajorVersion == 2) &&
           (newScale[0] <= 0 || newScale[1] <= 0 || newScale[2] <= 0)) {
