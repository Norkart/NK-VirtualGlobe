...
/**
 * Java3D implementation of a Midi Source.
 * <p>
 *
 * @author Alan Hudson
 * @version $Revision: 1.1 $
 */
public class J3DMidiSource extends BaseMidiSource implements J3DVRMLNode {

    /**
     * Construct a default node with an empty info array any the title set to
     * the empty string.
     */
    public J3DMidiSource() {
        super();
    }
     ...
     */
    public J3DMidiSource(VRMLNodeType node) {
        super(node);
    }
