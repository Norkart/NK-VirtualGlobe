...
/**
 * Java3D implementation of a WorldInfo node.
 * <p>
 *
 * This node is purely informational within the scenegraph. It does not have
 * a Java3D representation.
 *
 * @author Justin Couch
 * @version $Revision: 1.6 $
 */
public class J3DWorldInfo extends BaseWorldInfo implements J3DVRMLNode {
     ...
     */
    public J3DWorldInfo(VRMLNodeType node) {
        super(node);
    }
