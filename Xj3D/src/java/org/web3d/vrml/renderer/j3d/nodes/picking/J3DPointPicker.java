...
/**
 * Java3D -renderer implementation of a PointPicker node.
 * <p>
 *
 * @author Justin Couch
 * @version $Revision: 1.4 $
 */
public class J3DPointPicker extends BasePointPicker
     ...
     */
    public J3DPointPicker(VRMLNodeType node) {
        super(node);
        targetSet = new HashMap();
        allParentPaths = new ObjectArray();
    }
        ...
        for(int i = 0; i < numValid; i++) {
            if (targets[i] instanceof VRMLProtoInstance) {
                ...
                if (node instanceof VRMLProtoInstance) {
                    System.out.println("PROTO walk not implemented in J3DPointPicker");
                }
