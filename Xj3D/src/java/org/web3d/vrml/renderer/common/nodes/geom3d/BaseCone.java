...
public abstract class BaseCone extends AbstractNode
    ...
    public void setValue(int index, float value)
        ...
        switch(index) {
            case FIELD_HEIGHT:
                if(!inSetup)
                    throw new InvalidFieldAccessException("height", this);
            ...
            case FIELD_BOTTOM_RADIUS:
                if(!inSetup)
                    throw new InvalidFieldAccessException("bottomRadius", this);
    ...
    public void setValue(int index, boolean value)
        ...
        switch(index) {
            case FIELD_SIDE:
                if(!inSetup)
                    throw new InvalidFieldAccessException("side", this);
            ...
            case FIELD_BOTTOM:
                if(!inSetup)
                    throw new InvalidFieldAccessException("bottom", this);
            ...
            case FIELD_SOLID:
                ...
                if(!inSetup)
                    throw new InvalidFieldAccessException("solid", this);
