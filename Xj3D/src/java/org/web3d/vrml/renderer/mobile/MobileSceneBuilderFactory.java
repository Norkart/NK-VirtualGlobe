 ...
 */
public class MobileSceneBuilderFactory implements SceneBuilderFactory {
     ...
     */
    public MobileSceneBuilderFactory(boolean forceVRML97,
    ...
    public SceneBuilder createBuilder() {
        ...
        MobileVRMLSceneBuilder builder = new MobileVRMLSceneBuilder();
