...
import org.web3d.vrml.renderer.mobile.MobileProtoCreator;
 ...
 */
class MobileMainSceneBuilder extends CRMainSceneBuilder {
     ...
     * be producing nodes that conform to the {@link MobileVRMLNode} interface
     ...
     */
    MobileMainSceneBuilder(VRMLNodeFactory fac) {
        super(fac);
    }
    ...
    public void startNode(String name, String defName)
        ...
        if(protoMap.containsKey(name) || externProtoMap.containsKey(name)) {
            ...
            if(proto_def != null) {
                if(protoCreator == null) {
                    protoCreator = new MobileProtoCreator(nodeFactory,
                                                          worldURL,
                                                          majorVersion,
                                                          minorVersion);
                ...
                node = (MobileVRMLNode)protoCreator.newInstance(proto_def,
                                                                root,
                                                                majorVersion,
                                                                minorVersion,
                                                                inStatic);
            ...
            node = (MobileVRMLNode)nodeFactory.createVRMLNode(name,
                                                              inStatic);
        }
        ...
        if(defName != null) {
            ...
            scene.addDEFNode(defName, (MobileVRMLNode)node);
