...
public class Material extends NodeComponent {
    ...
    public void renderState(GLDrawable gld) {
        ...
        if (listName == null) {
            ...
            gl.glMaterialfv(GLEnum.GL_FRONT, GLEnum.GL_DIFFUSE, diffuseColor);
            gl.glMaterialfv(GLEnum.GL_FRONT, GLEnum.GL_AMBIENT, ambientColor);
            gl.glMaterialfv(GLEnum.GL_FRONT, GLEnum.GL_SPECULAR, specularColor);
            gl.glMaterialfv(GLEnum.GL_FRONT, GLEnum.GL_EMISSION, emissiveColor);
            gl.glMaterialf(GLEnum.GL_FRONT, GLEnum.GL_SHININESS, shininess);
