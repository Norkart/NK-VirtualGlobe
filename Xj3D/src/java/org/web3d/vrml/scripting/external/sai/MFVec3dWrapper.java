...
class MFVec3dWrapper extends BaseFieldWrapper
    ...
    public void get1Value(int index, double[] vec) {
        if (storedOutput)
            ...
            if (index<0 || index>=data.numElements)
                ...
                System.arraycopy(data.doubleArrayValue,index*3,vec,0,3);
        }
    }
    ...
    public void getValue(double[] vec) {
        if (storedOutput) {
            ...
            if (data.numElements!=0)
                System.arraycopy(data.doubleArrayValue,0,vec,0,data.numElements*3);
        }
    }
    ...
    public void getValue(double[][] vec) {
        if (storedOutput) {
            ...
            checkReadAccess();
            VRMLFieldData data=theNode.getFieldValue(fieldIndex);
            ArrayUtils.raise3(data.doubleArrayValue,data.numElements,vec);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.doubleArrayValue,0,storedInputValue,0,value.numElements*3);
        storedInput=true;
    ...
    public void loadOutputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.doubleArrayValue,0,storedOutputValue,0,value.numElements*3);
        storedOutput=true;
    }
