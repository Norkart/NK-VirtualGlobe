    ...
    public void getValue(float dest[]) {
        if (isStored)
            ...
            try {
                ...
                System.arraycopy(
                    fieldData.floatArrayValue,0,dest,0,fieldData.numElements*4
                );
    ...
    public void get1Value(int index, float[] dest) {
        if (isStored)
            ...
            try {
                ...
                System.arraycopy(
                    fieldData.floatArrayValue, index*4, dest, 0, 4
                );
            } catch (InvalidFieldException ife) {
    ...
    public void getValue(float[][] dest) {
        if (isStored) {
            ...
            try {
                ...
                ArrayUtils.raise4(fieldData.floatArrayValue,arraySize,dest);
            } catch (InvalidFieldException ife) {
    ...
    public float[][] getValue() {
        ...
        if (isStored) {
            ...
            try {
                VRMLFieldData fieldData=theNode.getFieldValue(theFieldID);
                int arraySize=fieldData.numElements;
                ArrayUtils.raise4(fieldData.floatArrayValue,arraySize,result);
                return result;
            } catch (InvalidFieldException ife) {
                throw new RuntimeException("Error reading field value");
        }
