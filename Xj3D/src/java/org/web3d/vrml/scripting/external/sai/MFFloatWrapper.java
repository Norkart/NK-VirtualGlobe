...
class MFFloatWrapper extends BaseFieldWrapper
    ...
    public float get1Value(int index)
        ...
        if (storedOutput)
            ...
            if (index<0 || index>=value.numElements)
                ...
                return value.floatArrayValue[index];
        }
    }
    ...
    public void getValue(float[] values) {
        if (storedOutput)
            ...
            if (data.numElements!=0)
                System.arraycopy(data.floatArrayValue,0,values,0,data.numElements);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.floatArrayValue,0,storedInputValue,0,value.numElements);
        storedInput=true;
    ...
    public void loadOutputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.floatArrayValue,0,storedOutputValue,0,value.numElements);
        storedOutput=true;
    }
