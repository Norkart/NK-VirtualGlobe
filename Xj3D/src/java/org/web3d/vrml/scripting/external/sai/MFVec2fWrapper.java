...
class MFVec2fWrapper extends BaseFieldWrapper
    ...
    public void get1Value(int index, float[] vec) {
        if (storedOutput) {
            ...
            if (index<0 || index>=value.numElements)
                ...
                vec[0]=value.floatArrayValue[index];
                vec[1]=value.floatArrayValue[index+1];
            }
        }
    }
    ...
    public void getValue(float[] vec) {
        if (storedOutput)
            ...
            if (data.numElements!=0)
                System.arraycopy(data.floatArrayValue,0,vec,0,data.numElements*2);
        }
    }
    ...
    public void getValue(float[][] vec) {
        if (storedOutput)
            ...
            checkReadAccess();
            VRMLFieldData data=theNode.getFieldValue(fieldIndex);
            ArrayUtils.raise2(data.floatArrayValue,data.numElements,vec);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.floatArrayValue,0,storedInputValue,0,value.numElements*2);
        storedInput=true;
    ...
    public void loadOutputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.floatArrayValue,0,storedOutputValue,0,value.numElements*2);
        storedOutput=true;
    }
