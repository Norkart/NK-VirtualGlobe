...
class MFVec2dWrapper extends BaseFieldWrapper
    ...
    public void get1Value(int index, double[] vec) {
        if (storedOutput) {
            ...
            if (index<0 || index>=value.numElements)
                ...
                vec[0]=value.doubleArrayValue[index];
                vec[1]=value.doubleArrayValue[index+1];
            }
        }
    }
    ...
    public void getValue(double[] vec) {
        if (storedOutput)
            ...
            if (data.numElements!=0)
                System.arraycopy(data.doubleArrayValue,0,vec,0,data.numElements*2);
        }
    }
    ...
    public void getValue(double[][] vec) {
        if (storedOutput)
            ...
            VRMLFieldData data=theNode.getFieldValue(fieldIndex);
            ArrayUtils.raise2(data.doubleArrayValue,data.numElements,vec);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.doubleArrayValue,0,storedInputValue,0,value.numElements*2);
        storedInput=true;
    ...
    public void loadOutputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.doubleArrayValue,0,storedOutputValue,0,value.numElements*2);
        storedOutput=true;
    }
