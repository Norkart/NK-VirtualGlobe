...
class SFVec2dWrapper extends BaseFieldWrapper implements SFVec2d, ExternalEvent, ExternalOutputBuffer {
    ...
    public void getValue(double[] vec) {
        if (storedOutput) {
            ...
            if (data.doubleArrayValue==null)
                ...
                System.arraycopy(data.doubleArrayValue,0,vec,0,2);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.doubleArrayValue==null)
            ...
            System.arraycopy(value.doubleArrayValue,0,storedInputValue,0,2);
        storedInput=true;
    }
    ...
    public void loadOutputValue() {
        ...
        if (value.doubleArrayValue==null)
            ...
            System.arraycopy(value.doubleArrayValue,0,storedOutputValue,0,2);
        storedOutput=true;
    }
