...
class SFVec2fWrapper extends BaseFieldWrapper implements SFVec2f, ExternalEvent, ExternalOutputBuffer {
    ...
    public void getValue(float[] vec) {
        if (storedOutput) {
            ...
            if (data.floatArrayValue==null)
                ...
                System.arraycopy(data.floatArrayValue,0,vec,0,2);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.floatArrayValue==null)
            ...
            System.arraycopy(value.floatArrayValue,0,storedInputValue,0,2);
        storedInput=true;
    }
    ...
    public void loadOutputValue() {
        ...
        if (value.floatArrayValue==null)
            ...
            System.arraycopy(value.floatArrayValue,0,storedOutputValue,0,2);
        storedOutput=true;
    }
