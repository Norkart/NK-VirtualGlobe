...
public class MFDouble extends FieldScriptableObject {
    ...
    public Object get(int index, Scriptable start) {
        ...
        if((index >= 0) && (index < valueList.size())) {
            ret_val = (ReusableDouble) valueList.get(index);
        } else if(index >= 0) {
    ...
    public String toString() {
        ...
        for(int i = 0; i < size; i++) {
            flt = (ReusableDouble) valueList.get(i);
            buf.append(flt);
            buf.append(' ');
        }
    ...
    /**
     * Get the array of underyling float values.
     *
    ...
    public double[] getRawData() {
        ...
        for(int i=0; i < valueList.size();i++) {
            ret_val[i] = ((ReusableDouble)valueList.get(i)).doubleValue();
        }
    ...
    public void getRawData(float[] value) {
        for(int i=0; i < valueList.size();i++) {
            value[i] = ((ReusableDouble)valueList.get(i)).floatValue();
        }
    }
    ...
    public void getRawData(double[] value) {
        for(int i=0; i < valueList.size();i++) {
            value[i] = ((ReusableDouble)valueList.get(i)).doubleValue();
        }
    }
}
