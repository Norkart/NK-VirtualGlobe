...
public class SFVec4d extends FieldScriptableObject {
     ...
     */
    public SFVec4d jsFunction_add(Scriptable sc) {
        if (!(sc instanceof SFVec4d)) {
            Context.reportRuntimeError(INVALID_TYPE_MSG);
        }

        SFVec4d vec = (SFVec4d) sc;
     ...
     * @return The product
     */
    public SFVec4d jsFunction_cross(Scriptable sc) {
        if (!(sc instanceof SFVec4d)) {
            Context.reportRuntimeError(INVALID_TYPE_MSG);
        }
     ...
     */
    public SFVec4d jsFunction_subtract(Scriptable sc) {
        if (!(sc instanceof SFVec4d)) {
            Context.reportRuntimeError(INVALID_TYPE_MSG);
        }
