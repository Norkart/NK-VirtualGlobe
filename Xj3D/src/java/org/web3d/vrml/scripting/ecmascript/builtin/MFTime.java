...
public class MFTime extends FieldScriptableObject {
    ...
    public Object get(int index, Scriptable start) {
        ...
        if((index >= 0) && (index < valueList.size())) {
            ret_val = (ReusableFloat) valueList.get(index);
        } else if(index >= 0) {
    ...
    public String toString() {
        ...
        for(int i = 0; i < size; i++) {
            flt = (ReusableFloat) valueList.get(i);
            buf.append(flt);
            buf.append(' ');
        }
    ...
    /**
     * Get the array of underyling double values.
     *
    ...
    public double[] getRawData() {
        ...
        for(int i=0; i < valueList.size();i++) {
            ret_val[i] = ((ReusableFloat)valueList.get(i)).doubleValue();
        }
    ...
    public void getRawData(double[] value) {
        for(int i=0; i < valueList.size();i++) {
            value[i] = ((ReusableFloat)valueList.get(i)).doubleValue();
        }
    }
}
