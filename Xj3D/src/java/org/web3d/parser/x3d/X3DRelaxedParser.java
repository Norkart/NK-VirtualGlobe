/* Generated By:JavaCC: Do not edit this line. X3DRelaxedParser.java */
/*****************************************************************************
 ...
 */
public class X3DRelaxedParser implements X3DRelaxedParserConstants {
 ...
 * </pre>
 */
  final public void ProfileDecl() throws ParseException {
    String prof_name;
 ...
 * </pre>
 */
  final public void ComponentDecl() throws ParseException {
    String comp_name;
 ...
 * </pre>
 */
  final public void MetaDecl() throws ParseException {
    String key;
    String value;
 ...
 * </pre>
 */
  final public void ProtoBodyStatement() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case DEF:
    case USE:
    case SCRIPT:
    ...
    case EXPORT:
      jj_consume_token(EXPORT);
        {if (true) throw new ParseException("Cannot use EXPORT statements in a proto body declaration");}
      break;
    default:
      jj_la1[4] = jj_gen;
      jj_consume_token(-1);
 ...
 * </pre>
 */
  final public String[] BooleanArray() throws ParseException {
    stringArray.clear();
    label_16:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 */
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0xc260000,0x0,0x100000,0xc260000,0xc260000,0x60000,0x20000,0x4200000,0x3c00000,0x4200000,0xc260000,0x1c00000,0x3c00000,0x3c00000,0x0,0x0,0x1000,0x9000,0xc200000,0xfe00000,0x0,0xc200000,0xc200000,0xfe00000,0x20000000,0x20000000,0x3000000,0x200e9800,0x3c00000,0x3c00000,0xe9800,0xe1800,0x60000,0x800,0x1800,0x1000,0x0,0x0,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x96,0x1,0x0,0x96,0x96,0x90,0x90,0x0,0x0,0x0,0x96,0x0,0x0,0x0,0x8,0x8,0x0,0x0,0x80,0x80,0x90,0x80,0x80,0x80,0x0,0x0,0x0,0xf0,0x0,0x0,0xf0,0xf0,0x90,0x60,0x60,0x0,0x60,0x60,};
   }
  final private JJCalls[] jj_2_rtns = new JJCalls[5];
  private boolean jj_rescan = false;
  private int jj_gc = 0;

  public X3DRelaxedParser(java.io.InputStream stream) {
     this(stream, null);
  }
  public X3DRelaxedParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new X3DRelaxedParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public X3DRelaxedParser(java.io.Reader stream) {
  ...
  public X3DRelaxedParser(X3DRelaxedParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(X3DRelaxedParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
