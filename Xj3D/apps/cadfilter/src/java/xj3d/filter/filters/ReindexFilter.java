 ...
 * and IndexedTriangleFanSet nodes to their most compact form. This filter
 * will remove duplicate coordinates from the coordinate point array and
 * recreate the index array to coorespond to the modified coordinate points.
 * <p>
 ...
 */
public class ReindexFilter extends TypeConversionFilter {
    
    /** The set of nodes that require translation */
    private static final String[] NODE = new String[] {
    ...
    public ReindexFilter() {
        ...
        coordMap = new HashMap<String, CoordinateProcessor>();
    }
    ...
    public void endNode() throws SAVException, VRMLException {
        ...
        if (intercept) {
            ...
            if (nodeName.equals(NODE[intercept_index])) {
                reindex();
                intercept = false;
                intercept_index = -1;
                node = null;
    ...
    private void reindex() {
        ...
        ComposedGeometry geometry = (ComposedGeometry)node;
        if (geometry != null) {
            float[] point = null;
            ...
            if (coord != null) {
                ...
                if (useName != null) {
                    ...
                    point = coord.point;
                    if (point != null) {
                        cp = new CoordinateProcessor(point);
