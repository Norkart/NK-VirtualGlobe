...
public class ParserNameMap implements FileNameMap {
    ...
    private HashMap contentTypeMap;
    ...
    public String getContentTypeFor(String filename) {
        ...
        return (String)contentTypeMap.get(ext);
    }
    ...
    public void registerType(String extension, String mimetype) {
        contentTypeMap.put(extension, mimetype);
        reverseMap.put(mimetype, extension);
    }
