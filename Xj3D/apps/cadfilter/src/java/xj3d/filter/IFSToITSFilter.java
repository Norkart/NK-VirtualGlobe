 ...
 */
public class IFSToITSFilter extends AbstractFilter {
    ...
    public void endNode() throws SAVException, VRMLException {
        ...
        if (nodeName.equals("IndexedFaceSet")) {
            ...
            if (fieldValues.get("Coordinate.point") != null) {
                coords = (String)fieldValues.get("Coordinate.point");
            }

            if (coords == null || coordIndex == null) {
            ...
            for(int i=0; i < len; i++) {
                ...
                System.out.println(i + "    " + start + "   " + p1 + "  " + p2);

                index.add(String.valueOf(start));
                index.add(String.valueOf(p1));
                index.add(String.valueOf(p2));

            }

            String[] values = (String[]) index.toArray(new String[0]);
...
System.out.println("IFSToITSFilter not hanlding binary coordinate data");
